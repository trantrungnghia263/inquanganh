...
function BlogPage() {
  useDocumentTitle("Tin tức - In Quang Anh");
                ...
                <>
                  ...
                  <div className="pagination flex justify-center items-center mt-8 gap-2">
                    <button
                      ...
                      className="pagination__button w-8 h-8 group flex items-center justify-center bg-slate-100 text-slate-700 hover:bg-red-700 hover:text-white transition duration-300"
                    >
                      <svg
                    ...
                    {pageNumbers.map((number) => (
                      <button
                        ...
                        className={`pagination__button flex items-center justify-center w-8 h-8 hover:bg-red-700 hover:text-white transition duration-300 ${
                          currentPage === number
        ...
        <div className="blog-page__bottom pt-14">
          ...
          <div className="pt-8">
            ...
            >
              ...
              <div className="swiper-button-prev w-10 h-10 rounded-full bg-red-700 z-10">
                {prevIcon}
              </div>
              <div className="swiper-button-next w-10 h-10 rounded-full bg-red-700 z-10">
                {nextIcon}
              </div>
            </Swiper>
          </div>
