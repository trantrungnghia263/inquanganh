...
function PolicyPage() {
  ...
  const policies = useMemo(
    () => [
      ...
      <p class="policy-page__paragraph text-base text-gray-500 pb-2">
      In Quang Anh giao hàng tận nơi cho khách hàng tại các thành phố lớn trong cả nước. Hình thức gửi hàng thông qua bưu điện hoặc gửi xe khách đi các tỉnh. Một số trường hợp quận huyện xa xôi, khó khăn trong giao hàng, quý khách vui lòng lấy hàng tại văn phòng nhà xe ở tỉnh thành đó.
      </p>
      <p class="policy-page__paragraph text-base text-gray-500 pb-4">
      ...
      <p class="policy-page__paragraph text-base text-gray-500">
      Quý khách có thể được đổi trả hàng khi số lượng sản phẩm do In Quang Anh sản xuất ra bị lỗi nhiều trên 40% quý khách có thể được hoàn lại tiền hoặc hoàn lại bằng sản phẩm mới tưng ứng số sản phẩm quý khách đã nhận đặt in
      ...
      <p class="policy-page__paragraph text-base text-gray-500 pb-2">
      Trong trường hợp mà bạn cảm thấy sản phẩm của bạn đặt in mà không đúng như theo trên đơn hàng thì hay nhanh tay liên hệ lại với In Quang Anh cảu chúng tôi để được nhân viên tư vấn và kiểm tra lại sản phẩm. Nếu đúng như giao hàng sai chúng tôi sẽ thu lại và hoàn lại sản phẩm cho bạn theo đúng như đơn
      </p>
      <h6 class="policy-page__title text-base text-red-700 uppercase py-3">
      ...
      <p class="policy-page__paragraph text-base text-gray-500">
      In Quang Anh luôn luôn bảo mật thông tin cho tất cả các khách hàng đến đặt in sản phẩm của chúng tôi . Chúng tôi cam kết không bán thông tin hay làm gì ảnh hưởng đến thông tin của khác hàng, và không để cho bên thứ 3 biết.
      </p>
      <h6 class="policy-page__title text-base text-red-700 uppercase py-3">
      ...
      <p class="policy-page__paragraph text-base text-gray-500 pb-2">
      – CÔNG TY TNHH IN QUANG ANH
      </p>
      <p class="policy-page__paragraph text-base text-gray-500 pb-2">
      – Các đối tác có ký hợp động thực hiện 1 phần dịch vụ do In Quang Anh. Các đối tác này sẽ nhận được những thông tin theo thỏa thuận hợp đồng (có thể 1phần hoặc toàn bộ thông tin tuy theo điều khoản hợp đồng) để tiến hành hỗ trợ người dùng sử dụng dịch vụ do Công ty cung cấp.
      </p>
      <h6 class="policy-page__title text-base text-red-700 uppercase py-3">
